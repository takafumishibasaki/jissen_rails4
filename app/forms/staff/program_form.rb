class Staff::ProgramForm
  ...
  private
    def program_params
      @params.require(:program).permit(:title, :description, :application_start_date,
      :application_start_hour, :application_start_minute, :application_end_date,
      :applicaiton_end_hour, :application_end_minute, :min_number_of_participants,
